...
class App extends Component {
  ...
  componentDidMount = () => {
    axios.get("http://localhost:3000/add/").then((res) => {
  ...
  addlist = (e) => {
    ...
    axios
      .post("http://localhost:3000/add/", lists)
  ...
  handleIncrement = (counter) => {
    ...
    axios
      .patch(`http://localhost:3000/add/counter/${counter}`, {
  ...
  handlereset = () => {
    ...
    // });
    axios
      .patch(`http://localhost:3000/add/reset/`, {
        value: (lists.value = 0),
      })
      .then((res) => console.log(res.data));
    this.setState({ lists });
  ...
  deletelist = (key) => {
    axios
      .delete("http://localhost:3000/add/" + key)
      .then((res) => console.log(res.data));
  ...
  editvalue = (counter) => {
    ...
    axios
      .patch(`http://localhost:3000/add/edit/${counter}`, {
  ...
  onsavetext = (counter, text) => {
    ...
    axios
      .patch(`http://localhost:3000/add/save/${counter}`, {
